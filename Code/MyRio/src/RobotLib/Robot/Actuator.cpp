...
Actuator::Actuator(unsigned char actuator_en_, unsigned char current_pin_, unsigned char fault_pin_, unsigned char dir_pin_, float motor_kt_, float max_torque_, float v_a_ratio_, int analog_out_pin_, int fault_level_, bool flip_dir_):
    motor_kt(motor_kt_),
